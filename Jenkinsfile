	...
	stages {
        ...
        */
        stage("Build Backend Image"){
			when {
                expression { (PARAMETER == 'ALL') ||(PARAMETER == 'TEST AND DEPLOY') || (PARAMETER == 'DEPLOY')}
            }
            steps{
                script{
        ...
        stage("Publish images"){
            ...
            stage('Deploy React') {
			when {
                expression { (PARAMETER == 'ALL') ||(PARAMETER == 'TEST AND DEPLOY') || (PARAMETER == 'DEPLOY') || (PARAMETER == 'FAST DEPLOY')}
            } 
            steps {
